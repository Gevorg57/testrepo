...
tesla_revenue_mod = pd.DataFrame(list(tesla_revenue.items()), columns=['Date', 'Revenue']) 
make_graph(tesla_data, tesla_revenue_mod, 'Tesla')
...
gme_revenue_mod = pd.DataFrame(list(gme_revenue.items()), columns=['Date', 'Revenue']) 
make_graph(gme_data, gme_revenue_mod, 'GameStop')
